...
-(void)viewLayout
{
    ...
    personnelLabel.font=[UIFont fontWithName:@"Arial" size:12];
...
-(void)uibuttonLayout
{
    ...
    startingLabel.font=[UIFont fontWithName:@"Arial" size:14];
    ...
    arriveLabel.font=[UIFont fontWithName:@"Arial" size:14];
...
-(void)textLabelLayout
{
    ...
    dateLabelView.font=[UIFont fontWithName:@"Arial" size:14];
...
-(void)timeTXLayout
{
    ...
    remindLabel.font=[UIFont fontWithName:@"Arial" size:14];
