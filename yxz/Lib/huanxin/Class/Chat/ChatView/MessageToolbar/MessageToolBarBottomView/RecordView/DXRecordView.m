...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel.layer.borderColor = [[UIColor colorWithRed:232/255.0f green:55/255.0f blue:74/255.0f alpha:1] colorWithAlphaComponent:0.5].CGColor;
...
-(void)recordButtonDragOutside
{
    ...
    _textLabel.backgroundColor = [UIColor colorWithRed:232/255.0f green:55/255.0f blue:74/255.0f alpha:1];
}
