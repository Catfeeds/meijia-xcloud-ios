...
//                pageViewVC=[storys instantiateInitialViewController];
        ...
        }else if([action isEqualToString:@"addressbook"]){
            if ([params isEqualToString:@"list"]) {
                //通讯录入口
