...
//    self.goodsIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@", goods.goodsIcon]];
    self.goodsNameLabel.text = [NSString stringWithFormat:@"%@", goods.name];
    self.goodsOriginalPriceLabel.text = [NSString stringWithFormat:@"%@", goods.place];
    self.goodsSalePriceLabel.text = [NSString stringWithFormat:@"剩余:%d件", goods.stock];
