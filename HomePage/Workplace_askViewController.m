...
-(void)tabBarAction:(UIButton *)button
{
    ...
    headLineView.frame=CGRectMake(60*(button.tag-1000), 49, 60, 2);
...
-(void)interfaceLayout
{
    ...
    if (butID==1000) {
        if (self.loginYesOrNo) {
            dict=@{@"user_id":_manager.telephone,@"feed_from":@"0",@"feed_type":@"2",@"page":pageStr};
        }else{
            dict=@{@"feed_from":@"0",@"feed_type":@"2",@"page":pageStr};
        }
