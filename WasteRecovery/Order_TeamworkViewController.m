//
//  Order_TeamworkViewController.m
//  yxz
//
...
@interface Order_TeamworkViewController ()
{
    UILabel *waterName;
    UILabel *moneyLabel;
...
@implementation Order_TeamworkViewController
...
//    NSString *company_name=[NSString stringWithFormat:@"%@",[delegate.globalDic objectForKey:@"company_name"]];
    if (waterString==nil||waterString==NULL||[waterString isEqualToString:@""]) {
        ...
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"link_tel":mobileString,@"remarks":remarksString};
            
        }else if (mobileString==nil&&nameString!=nil&&remarksString!=nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"link_man":nameString,@"remarks":remarksString};
        }else if (remarksString==nil&&mobileString!=nil&&nameString!=nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"link_man":nameString,@"link_tel":mobileString};
                        
        }else if (nameString==nil&&mobileString==nil&&remarksString!=nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"remarks":remarksString};
            
        }else if (nameString==nil&&remarksString==nil&&mobileString!=nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"link_tel":mobileString};
            
        }else if (remarksString==nil&&mobileString==nil&&nameString!=nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id,@"link_man":nameString};
            
        }else if (nameString==nil&&mobileString==nil&&remarksString==nil)
        {
            _dict = @{@"user_id":_manager.telephone,@"city_id":addressID,@"team_type":service_price_id};
...
-(void)buttonAction:(UIButton *)button
{
    switch (button.tag) {
        case 0:
        {
            ...
            waterListVC.listID=102;
            [self.navigationController pushViewController:waterListVC animated:YES];
        }
            break;
        case 1:
        {
            userdressVC=[[TeamWorkCityViewController alloc]init];
