...
-(void)viewDidLoad
{
    ...
    if (_vcID==100) {
        ...
        [self.userPortrait setImageWithURL:[NSURL URLWithString:imageUrl]placeholderImage:nil];
        self.logoutButton.hidden=YES;
        UIView *view =[[UIView alloc]initWithFrame:FRAME(0, 196, WIDTH, HEIGHT-195)];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onClickSavess) name:@"YMcommunity" object:nil];
...
-(void)onClickSave
{
    ...
    if (self.settingCompletion) {
        ...
        NSDictionary *_dict = @{@"user_id":_manager.telephone,@"name":self.userAccount.name};
