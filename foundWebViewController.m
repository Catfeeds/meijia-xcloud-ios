...
- (void)viewDidLoad {
    ...
    if ([_goto_type isEqualToString:@"h5+list"]) {
        ...
        //免费咨询button
        UIButton * consultingBtn = [[UIButton alloc]initWithFrame:FRAME(WIDTH - 200, 0, 100, 50)];
        consultingBtn.backgroundColor = [UIColor colorForHex:@"33CCFF"];
        [consultingBtn setTitle:@"免费咨询" forState:UIControlStateNormal];
        [consultingBtn addTarget:self action:@selector(consultingButton:) forControlEvents:UIControlEventTouchUpInside];
        [buttonView addSubview:consultingBtn];
...
-(void)consultingButton:(UIButton *)sender{
